...
export declare class GatewayService {
    ...
    createForwardMessage(dto: MessageForwardCreateDto, server: Server): Promise<void>;
    createForwardMessageWithImg(dto: messageForwardWithImgReplyDto, server: Server): Promise<void>;
