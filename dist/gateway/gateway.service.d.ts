...
export declare class GatewayService {
    ...
    private prisma;
    private messageS;
    constructor(chat: ChatService, blockUser: BlockUserService, leftChat: LeftChatService, prisma: PrismaService, messageS: MessageService);
    create(messageCreateDto: MessageCreateDto, server: Server): Promise<string>;
    createWithImg(message: Message, contentImg: ContentImg[], server: Server): void;
