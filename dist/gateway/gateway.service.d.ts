...
import { MessageDto, MessageReplyCreateDto } from 'src/message/dto/messageDto.dto';
import { messageReplyWithImgCreateDto, messageWithImgCreateDto } from 'src/message/dto/messageCreateWithImg.dto';
...
export declare class GatewayService {
    ...
    constructor(chat: ChatService, blockUser: BlockUserService, leftChat: LeftChatService, prisma: PrismaService, messageS: MessageService, contentImg: ContentImgService, storage: StorageService, user: UserService, replyMessage: ReplyMessageService);
